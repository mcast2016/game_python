...
def main():
    ...
    canvas.create_image(bg_pos+240, 320, image=img_bg, tag="SCREEN")
    if index == 0:
        canvas.create_text(240,240,text="DORANEKO",fill="gold",font=fnt2, tag="SCREEN")
    ...
    if index == 2:
        ...
        if timer ==60:
            ...
            index =0
            timer =0
    canvas.create_text(240,30, text="SCREEN")
    if koff ==True:
        print("main_7")
        key = ""
        koff =False
...
canvas.pack()
img_player = [
    tkinter.PhotoImage(file="/home/pi/Downloads/py2_samples/Chapter2/dora0.png"),
    tkinter.PhotoImage(file="/home/pi/Downloads/py2_samples/Chapter2/dora1.png")
]
img_enemy = tkinter.PhotoImage(file="/home/pi/Downloads/py2_samples/Chapter2/fun.png")
img_bg = tkinter.PhotoImage(file="/home/pi/Downloads/py2_samples/Chapter2/building.png")
main()
root.mainloop()