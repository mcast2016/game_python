...
canvas.pack()
img_player = [
    tkinter.PhotoImage(file="/home/pi/Downloads/py2_samples/Chapter2/starship0.png"),
    tkinter.PhotoImage(file="/home/pi/Downloads/py2_samples/Chapter2/starship1.png")
]
img_enemy = tkinter.PhotoImage(file="/home/pi/Downloads/py2_samples/Chapter2/meteo.png")
img_bg = tkinter.PhotoImage(file="/home/pi/Downloads/py2_samples/Chapter2/cosmo.png")
main()
root.mainloop()